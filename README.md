...
> Welcome to the CaoYuan&#39;s blog!This blog is dedicated to a wide variety of topics including quantitative trading, artificial intelligence, machine learning, blockchain, virtual reality and the Internet of Things.
...
```yml
title: Caoyuan
subtitle: CaoYuan&#39;s blog
description: Welcome to the CaoYuan&#39;s blog!This blog is dedicated to a wide variety of topics including quantitative trading, artificial intelligence, machine learning, blockchain, virtual reality and the Internet of Things.
keywords:
# 作者名称，会显示在侧边栏
author: cy
```
...
```sh
# 克隆仓库
$ git clone https://github.com/zizhuspot/caoyuan.varygames.com.git
# 安装依赖
$ yarn install
# 运行
$ yarn server
